  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      <div class="wrapper">
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button type="primary" size="large" @click="submitOrders">提交订单</el-button>
        </div>
      </div>
    </div>
  </div>
  ...
  <el-dialog title="切换收货地址" width="30%" center v-model="dialogVisible">
    <div class="addressWrapper">
      ...
      >
        ...
        <i class="iconfont icon-close-new close" @click="removeAddress(item)"></i>
      </div>
    </div>
    <template #footer>
    ...
    <div class="addressWrapper">
      <el-form label-width="100px" :model="formData" style="max-width: 460px">
        ...
        <el-form-item label="地址标签" required>
          <el-input placeholder="请输入地址标签" v-model="formData.addressTags" />
        </el-form-item>
        <el-form-item label="设为默认地址" required>
          <el-switch v-model="formData.isDefault" :active-value="0" :inactive-value="1" />
        </el-form-item>
      </el-form>
    </div>
    <template #footer>
